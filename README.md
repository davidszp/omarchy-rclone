...
<img src="docs/panel.png" alt="The rclone panel mid-transfer: a copy job with progress, four files in flight with per-file speed and ETA, a bandwidth cap, and mounted drives with their storage" width="420">
